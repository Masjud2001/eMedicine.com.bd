                ...
                <div className="max-w-7xl mx-auto space-y-32 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-20">
                        <div className="flex-1 space-y-10 text-center lg:text-left">
                            ...
                            <h1 className="text-5xl md:text-8xl font-black text-slate-900 leading-[1.05] tracking-tight italic underline decoration-slate-100 underline-offset-8">We are <span className="text-primary-500">eMedicine</span>. Helping Bangladesh Stay Healthy.</h1>
                    ...
                    <div className="bg-slate-900 p-12 md:p-24 rounded-[4rem] relative overflow-hidden group shadow-2xl">
                        ...
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 relative z-10">
                            <div className="space-y-6 text-center lg:text-left">
                                ...
                                <p className="text-lg font-medium text-slate-400 max-w-xl opacity-80 uppercase tracking-widest leading-relaxed">Start your journey with eMedicine today and get exclusive discounts.</p>
                            </div>
                            <Link href="/auth">
